...
public class AddfinishtimeEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addfinishtime_edit);
    }
    public void click12amfinish(View view3){
        ...
        if(!test){
            ...
            if (intfinihstime < intstarttime) {
                ...
                Intent nextpage3 = new Intent(AddfinishtimeEdit.this, Addedit.class);
