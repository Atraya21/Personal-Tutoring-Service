...
public class StartTimePage extends AppCompatActivity {
    int timech = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_time_page);
    }
    public void clicked12am(View view2){
        ...
        if(!test){
            ...
            Intent nextpage2 = new Intent(StartTimePage.this, FinishTimePage.class);
