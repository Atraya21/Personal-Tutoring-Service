...
public class StudentBankInfoEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_bank_info_edit);
    ...
    public void makeedit(View view) {
        ...
        Intent nextpage = new Intent(StudentBankInfoEdit.this, StudentHomepage.class);
        startActivity(nextpage);
    }
    public void homepage(View view){
        Intent nextpage1 = new Intent(StudentBankInfoEdit.this, StudentHomepage.class);
