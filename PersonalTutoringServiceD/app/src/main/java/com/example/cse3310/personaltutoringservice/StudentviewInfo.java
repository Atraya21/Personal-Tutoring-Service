...
public class StudentviewInfo extends AppCompatActivity {
    String fname = null;
    String lname = null;
    String phone = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studentview_info);
    ...
    public void edittext(View view){
        ...
        Intent intend = new Intent(StudentviewInfo.this,StudentEditinfo.class);
        startActivity(intend);


    }
    public void viewbank(View view){
        Intent intend = new Intent(StudentviewInfo.this,StudentBankinfoView.class);
        startActivity(intend);
